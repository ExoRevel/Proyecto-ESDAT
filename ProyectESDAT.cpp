...
void cuadrosiphone(){
	for(int i=0;i<3;i++){
		gotoxy(20+i,20);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(20+i,22);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(19,20+i);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(23,20+i);cout<<"="<<endl;
	}
	gotoxy(21,21);cout<<"1";
	gotoxy(18,24);cout<<"SPOTIFY";
	
	for(int i=0;i<3;i++){
		gotoxy(43+i,20);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(43+i,22);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(42,20+i);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(46,20+i);cout<<"="<<endl;
	}
	gotoxy(44,21);cout<<"2";
	gotoxy(42,24);cout<<"JUEGO";
	gotoxy(42,25);cout<<"PILAS";
	
	for(int i=0;i<3;i++){
		gotoxy(20+i,30);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(20+i,32);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(19,30+i);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(23,30+i);cout<<"="<<endl;
	}
	gotoxy(21,31);cout<<"3";
	gotoxy(18,34);cout<<"SERVICIO";
	gotoxy(17,35);cout<<"DELIVERY";
	
	for(int i=0;i<3;i++){
		gotoxy(20+i,40);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(20+i,42);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(19,40+i);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(23,40+i);cout<<"="<<endl;
	}
	
	gotoxy(21,41);cout<<"5";
	gotoxy(16,44);cout<<"CALCULADORA";
	
	for(int i=0;i<3;i++){
		gotoxy(43+i,30);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(43+i,32);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(42,30+i);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(46,30+i);cout<<"="<<endl;
	}
	gotoxy(44,31);cout<<"4";
	gotoxy(40,34);cout<<"CONTACTOS";
	
	for(int i=0;i<3;i++){
		gotoxy(43+i,40);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(43+i,42);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(42,40+i);cout<<"="<<endl;
	}
	for(int i=0;i<3;i++){
		gotoxy(46,40+i);cout<<"="<<endl;
	}
	gotoxy(44,41);cout<<"6";
	gotoxy(38,44);cout<<"BLOC DE NOTAS";
...
void cancionactual(PNodoR cancion){
	...
	const string ubicacion="C:\\iphone\\";
